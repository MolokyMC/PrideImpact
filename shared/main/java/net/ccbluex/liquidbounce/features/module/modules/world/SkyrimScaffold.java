...
public class SkyrimScaffold extends Module {
    ...
    public void onRender2D(final Render2DEvent event) {
        if (counterDisplayValue.get()) {
            ...
            //GL11.glPopMatrix();
            RenderUtils.drawRoundedRect((float) scaledResolution.getScaledWidth() / 2 - (infoWidth / 2) - 4, (float)scaledResolution.getScaledHeight() - 60, (float) scaledResolution.getScaledWidth() / 2 + (infoWidth / 2) + 4, (float) scaledResolution.getScaledHeight() - 74, 2, new Color(0.15F, 0.15F, 0.15F, progress).getRGB());
