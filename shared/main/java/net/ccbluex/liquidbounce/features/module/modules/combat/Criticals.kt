...
class Criticals : Module() {
    ...
    val modeValue = ListValue("Mode", arrayOf("PrideImpact","sb","NewPacket","HytSpartan","AAC4Hyt", "Lite", "HytTest", "HytVulcan",  "Vulcan", "vulcanfake", "Spartan", "StarPacket", "Packet", "NcpPacket", "NoGround", "Hop", "TPHop", "Jump", "LowJump", "Visual"), "Packet")
