...
class KillAura : Module() {
    ...
    private val vanillamode =  ListValue("VanillaMode", arrayOf("TryUseItem", "UseItem","GrimC07", "C08", "OldC08"), "TryUseItem")
    ...
    private val rotations = ListValue("RotationMode", arrayOf("None", "New", "Liquidbounce","BackTrack", "Test1", "Test2", "HytRotation","LSReborn"), "New")
    ...
    private fun startBlocking(interactEntity: IEntity, interact: Boolean) {
        if (LiquidBounce.moduleManager[OldHitting::class.java].state){
            ...
            if(autoBlockPacketValue.get().equals("Vanilla", true)) {
                ...
                if (vanillamode.get().equals("GrimC07", true)){
