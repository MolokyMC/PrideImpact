...
class Velocity : Module() {
    ...
    private val modeValue = ListValue("Mode", arrayOf("HYT","Custom","HytBest","AAC4","Simple", "SimpleFix","AAC", "AACPush", "AACZero",
        "Reverse", "SmoothReverse", "Jump", "AAC5Reduce", "HytPacketA" ,"Glitch","HytCancel","HytTick","Vanilla","HytTest","LightSense","HytPacket","NewAAC4","FeiLe","LightSenseFull","NewHytMotion","HytPacketB","HytMotionB","HytPacketFix","S27","LatestTestHyt","AAC5.2.0COMBAT","Spoof"), "Vanilla")
