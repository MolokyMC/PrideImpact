...
//        Fonts.font35.drawString(content, 24F + Fonts.font35.getStringWidth(title), height / 2F - 1F, ColorTxet, false)
        ...
        val colors = when(type.name) {
            "SUCCESS" -> Color(90,140,90,150)
            "WARNING","ERROR" -> Color(120,70,70,150)
            else -> Color(40,40,40,150)
        }
        ...
        Fonts.font30.drawString(title, 6F, 3F, textColor, true)
        font.drawString(content, 6F, 12F, textColor, true)
