...
class ScoreboardElement(
    ...
    private val serverValue = ListValue("ServerIp", arrayOf("None", "ClientName","Custom"), "ClientName")
    ...
    override fun drawElement(): Border? {
        ...
        if (outline.get()){
            RenderUtils.drawGidentOutlinedRoundedRect(l1 - 7.0, -5.0, 8.0 - (l1 - 7.0), (maxHeight + fontRenderer.fontHeight + 5).toDouble() - (-5.0), radius.get().toDouble(),linewidth.get())
        }
//Shadow!!!!
        if(!noshadow.get()){
