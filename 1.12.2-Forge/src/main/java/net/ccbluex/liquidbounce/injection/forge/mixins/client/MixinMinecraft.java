...
public abstract class MixinMinecraft {
    ...
    @Inject(method = "displayCrashReport", at = @At("HEAD"))
        ...
        try {
            ...
            fileWritter.write("##########################PRIDE CRASH REPORT##########################\r\n\r\n" +
                    "主播喜提崩端，好死，开香槟了" +
                    "\r\n\r\n" +
        ...
        File file1 = new File("./", "PrideCrashLogs.txt");
        ;
    ...
    private void createDisplay(CallbackInfo callbackInfo)  {
        Display.setTitle(LiquidBounce.CLIENT_NAME + " b" + LiquidBounce.CLIENT_VERSION );
    }

    @Inject(method = "displayGuiScreen", at = @At(value = "FIELD", target = "Lnet/minecraft/client/Minecraft;currentScreen:Lnet/minecraft/client/gui/GuiScreen;", shift = At.Shift.AFTER))
    private void displayGuiScreen(CallbackInfo callbackInfo) throws IOException, AWTException {
